  ...
  endpoints: (builder) => ({
    ...
    updateService: builder.mutation({
      ...
      async onQueryStarted(_, { queryFulfilled }) {
        baseQueryToast(queryFulfilled, "El servicio fue actualizado correctamente.");
      },
    ...
    createService: builder.mutation({
      ...
      async onQueryStarted(_, { queryFulfilled }) {
        baseQueryToast(queryFulfilled, "El servicio fue creado correctamente.");
      },
      invalidatesTags: ["Services"],
    }),
    deleteService: builder.mutation({
      ...
      async onQueryStarted(_, { queryFulfilled }) {
        baseQueryToast(queryFulfilled, "El servicio fue eliminado correctamente.");
      },
      invalidatesTags: ["Services"],
    }),
  }),
