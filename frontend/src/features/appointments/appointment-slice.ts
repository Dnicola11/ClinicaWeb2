  ...
  endpoints: (builder) => ({
    ...
    updateAppointment: builder.mutation({
      ...
      async onQueryStarted(_, { queryFulfilled }) {
        baseQueryToast(queryFulfilled, "La cita fue actualizada correctamente.");
      },
    ...
    createAppointment: builder.mutation({
      ...
      async onQueryStarted(_, { queryFulfilled }) {
        baseQueryToast(queryFulfilled, "La cita fue creada correctamente.");
      },
      invalidatesTags: ["Appointments"],
    }),
    deleteAppointment: builder.mutation({
      ...
      async onQueryStarted(_, { queryFulfilled }) {
        baseQueryToast(queryFulfilled, "La cita fue eliminada correctamente.");
      },
      invalidatesTags: ["Appointments"],
    }),
  }),
