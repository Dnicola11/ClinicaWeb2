    ...
    <form onSubmit={handleSubmit(onSubmit)} className="h-full">
      <div className="flex flex-col justify-between h-full">
        <div className="flex flex-col space-y-3">
          <FormInputText label="Nombre de Usuario" name="nickname" control={control} />
          <FormInputText label="Nombres" name="firstName" control={control} />
          <FormInputText label="Apellidos" name="lastName" control={control} />
          <FormInputText label="Celular" name="phoneNumber" control={control} mask="(999) 999-9999" type="mask" />
          <FormInputText label="Email" name="email" control={control} />
          <FormInputText label="Nota" name="note" control={control} type="area" />
        </div>
