  ...
  endpoints: (builder) => ({
    ...
    updateClient: builder.mutation({
      ...
      async onQueryStarted(_, { queryFulfilled }) {
        baseQueryToast(queryFulfilled, "El paciente fue actualizado correctamente.");
      },
    ...
    createClient: builder.mutation({
      ...
      async onQueryStarted(_, { queryFulfilled }) {
        baseQueryToast(queryFulfilled, "El paciente fue creado correctamente.");
      },
      invalidatesTags: ["Clients"],
    }),
    deleteClient: builder.mutation({
      ...
      async onQueryStarted(_, { queryFulfilled }) {
        baseQueryToast(queryFulfilled, "El paciente fue eliminado correctamente.");
      },
      invalidatesTags: ["Clients"],
    }),
  }),
