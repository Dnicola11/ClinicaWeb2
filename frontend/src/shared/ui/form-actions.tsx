...
export const FormActions = ({ onCancel, handleDelete, isEnabled = false, hasId, isProcessing, isDirty }: FormActionsProps) => {
  ...
  return (
    <div className="flex justify-between gap-3 mb-10">
      <ConfirmDialog />
      <Button type="button" outlined onClick={onCancel} label="Descartar Cambios" />
      <div className="flex gap-1">
        {handleDelete && hasId && <Button type="button" severity="danger" onClick={onDelete} label="Eliminar" />}
